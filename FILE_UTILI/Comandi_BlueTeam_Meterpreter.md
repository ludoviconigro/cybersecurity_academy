Perfetto, ora ti preparo **una lista completa di comandi da Blue Team *dentro Meterpreter***.
Questi non sono comandi offensivi: sono comandi utili per **analisi, investigazione, triage, raccolta informazioni forensi**, cioè quello che farebbe un SOC/DFIR *una volta ottenuto l’accesso alla macchina compromessa nel laboratorio*.

Sono perfetti per capire **come un attaccante si muove** e quindi come **un Blue Team può rilevarlo**.
